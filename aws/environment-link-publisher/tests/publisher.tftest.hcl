...
run "internet_facing_load_balancer_fails" {
  command = plan
...
run "application_load_balancer_fails" {
  command = plan

  override_data {
    target = data.aws_lb.gateway
    values = {
      arn                = "arn:aws:elasticloadbalancing:us-west-2:111111111111:loadbalancer/app/k8s-ryvnsyst-internal-0123456789/0123456789abcdef"
      name               = "k8s-ryvnsyst-internal-0123456789"
