...
provider "registry.terraform.io/hashicorp/google" {
  version     = "7.46.0"
  constraints = ">= 3.33.0, >= 3.83.0, >= 4.64.0, >= 5.31.0, >= 6.18.0, >= 6.19.0, >= 6.28.0, >= 7.39.0, ~> 7.46.0, < 8.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/google-beta" {
  version     = "7.46.0"
  constraints = ">= 4.64.0, >= 6.18.0, >= 6.19.0, >= 7.39.0, ~> 7.46.0, < 8.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/kubernetes" {
  version     = "2.38.0"
  constraints = ">= 2.10.0, ~> 2.38.0, < 4.0.0"
  hashes = [
